...
// edit form m already data show krne ke liye data ko fetch krna padega.. uss particular quote ka data jise edit krna hai toh uske liye useState hook ka use krenge and usme ek object assign kr denge with two keys author and text
    ...
    <h1 className='text-center text-5xl font-bold pt-8'>Edit Quote</h1>
      <form onSubmit={editquoteHandler} action="" className='p-10 bg-red-300 w-96 shadow-cyan-500/50 rounded-2xl m-auto mt-16 border-solid border-8 border-red-950 '>
        <div className='mt-1'>
          ...
          <input type="text" id='author' placeholder="Author's Name" value={input.author} ref={authorInputRef} />
        </div>

        <div className='mt-4'>
          <label className='block m-1' htmlFor="quote">Quote:</label>
          <textarea className='border-box focus:outline-none container' name="" id="quote" cols="15" rows="4" placeholder="Author's Quote" value={input.text} ref={quoteInputRef}></textarea>
        </div>
